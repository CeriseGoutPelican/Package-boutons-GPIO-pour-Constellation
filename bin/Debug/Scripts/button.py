""" BIBILOTHEQUE : button.py
    ========================

    Ce fichier permet de gérer le simple clic, le clic long et le double clic
    d'un bouton poussoir relié à un port GPIO d'un Raspberry Pi.
    Pour les tests, les boutons sont montés sur GND et non sur l'entrée 5V

    Le fichier a été récupéré à l'adresse suivante (Experiment 3) :
    http://www.python-exemplary.com/index_en.php?inhalt_links=navigation_en.inc.php&inhalt_mitte=raspi%2Fen%2Fswitches.inc.php

    La licence de ce fichier n'est pas connue
"""
